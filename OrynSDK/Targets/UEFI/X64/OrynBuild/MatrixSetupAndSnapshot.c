...
const OrynVmMatrixProfile gProfiles[] =
{
    { "NONE", 0, 0, 0, 0 },
    { "PIC", 1, 0, 0, 0 },
    { "APIC", 0, 1, 0, 0 },
...
const unsigned int gProfileCount = sizeof(gProfiles) / sizeof(gProfiles[0]);

...
int OrynBootInfoTestAll(const char* executable_path, const OrynProject* project,
...
int OrynBootInfoQuestionnaire(const char* executable_path, const char* project_file,

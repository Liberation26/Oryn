...
typedef struct OrynKernelPageFaultPolicyState
{
    ...
    unsigned long long ReservedBitFaults;
    unsigned long long InstructionFetchFaults;
    unsigned long long NullAddressFaults;
    unsigned long long UserRangeViolations;
    unsigned long long FaultsWithoutFrame;
    ...
    unsigned long long RecoverActions;
    unsigned long long KillProcessActions;
    unsigned long long KernelPanicActions;
    unsigned long long PolicyDecisionChecks;

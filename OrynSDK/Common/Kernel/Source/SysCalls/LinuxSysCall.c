    ...
    OrynSysCallPacket* packet)
{
    ...
    if (number == ORYN_LINUX_SYSCALL_WRITE)
    {
    ...
    else if (number == ORYN_LINUX_SYSCALL_GETPID)
    {
        OrynSysCallPreparePacket(packet, ORYN_SYSCALL_KIND_GET,
            ORYN_SYSCALL_NS_PROCESS, ORYN_SYSCALL_OP_PROCESS_GET_ID);
        CopyArguments(packet, arg0, arg1, arg2, arg3, arg4, arg5);
    }
    else if (number == ORYN_LINUX_SYSCALL_EXIT ||
        number == ORYN_LINUX_SYSCALL_EXIT_GROUP)
    {
        OrynSysCallPreparePacket(packet, ORYN_SYSCALL_KIND_EVENT,
    ...
    packet->Platform = ORYN_SYSCALL_PLATFORM_LINUX;
...
{
    OrynSysCallPacket packet;
    if (!LinuxSysCallTranslate(number, arg0, arg1, arg2, arg3, arg4, arg5, &packet))
    {

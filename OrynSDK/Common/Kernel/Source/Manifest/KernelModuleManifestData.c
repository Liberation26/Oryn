...
void OrynKernelModuleManifestInit(void)
{
    ...
    SetModule(OrynKernelModulePci, "PCI", "bus scan, config space, class decode, MSI, MSI-X, device interrupt records, AHCI/SATA driver binding", "BootInfoRsdp", requires_OrynKernelModulePci, 1U, 1, 0, 0, "OrynKernelModuleDefaultStop", "OrynKernelModuleDefaultPanic", "OrynKernelModuleDefaultShutdown", OrynKernelModuleDefaultStop, OrynKernelModuleDefaultPanic, OrynKernelModuleDefaultShutdown);
    ...
    SetModule(OrynKernelModuleFat32, "FAT32", "BPB, FSInfo, FAT, clusters, directories, files, block devices, MBR, GPT", "BootInfoFramebuffer", requires_OrynKernelModuleFat32, 1U, 1, 0, 0, "OrynKernelModuleDefaultStop", "OrynKernelModuleDefaultPanic", "OrynKernelModuleDefaultShutdown", OrynKernelModuleDefaultStop, OrynKernelModuleDefaultPanic, OrynKernelModuleDefaultShutdown);
    SetModule(OrynKernelModuleVfs, "VFS", "root mount, stat, read, write, delete, list, ELF64 user command loading, command descriptors, argv envp, standard handles, executable permissions", "BootInfoFramebuffer", requires_OrynKernelModuleVfs, 1U, 1, 0, 0, "OrynKernelModuleDefaultStop", "OrynKernelModuleDefaultPanic", "OrynKernelModuleDefaultShutdown", OrynKernelModuleDefaultStop, OrynKernelModuleDefaultPanic, OrynKernelModuleDefaultShutdown);

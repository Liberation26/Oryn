...
void OrynKernelModuleManifestInit(void)
{
    ...
    SetModule(OrynKernelModulePhysicalMemory, "PhysicalMemory", "usable pages, free list, allocation proof, DMA-safe constraints, contiguous constrained allocations", "BootInfoMemoryMap", requires_OrynKernelModulePhysicalMemory, 1U, 1, 0, 1, "OrynKernelModuleDefaultStop", "OrynKernelModuleDefaultPanic", "OrynKernelModuleDefaultShutdown", OrynKernelModuleDefaultStop, OrynKernelModuleDefaultPanic, OrynKernelModuleDefaultShutdown);
    ...
    SetModule(OrynKernelModuleVirtualMemory, "VirtualMemory", "PML4, CR3 switch, identity and higher-half maps, copy-on-write clone and fault resolution", "BootInfoMemoryMap,BootInfoKernelRange", requires_OrynKernelModuleVirtualMemory, 1U, 1, 0, 1, "OrynKernelModuleDefaultStop", "OrynKernelModuleDefaultPanic", "OrynKernelModuleDefaultShutdown", OrynKernelModuleDefaultStop, OrynKernelModuleDefaultPanic, OrynKernelModuleDefaultShutdown);
    SetModule(OrynKernelModuleProcess, "Process", "process structures, per-process address spaces, ownership, lifecycle state, copy-on-write child foundation", "BootInfoMemoryMap,BootInfoKernelRange", requires_OrynKernelModuleProcess, 1U, 1, 0, 1, "OrynKernelModuleDefaultStop", "OrynKernelModuleDefaultPanic", "OrynKernelModuleDefaultShutdown", OrynKernelModuleDefaultStop, OrynKernelModuleDefaultPanic, OrynKernelModuleDefaultShutdown);
